...
<head>
    ...
    <style>
        ...
        .code { font-size: 6rem; font-weight: 800; letter-spacing: -0.05em; color: #fbbf24; margin: 0; }
        .msg { font-size: 1.25rem; color: #94a3b8; margin-top: 0.5rem; }
...
<body>
    <div class="box">
        <p class="code">403</p>
        <p class="msg">You do not have permission to access this resource.</p>
